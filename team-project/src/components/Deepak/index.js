    ...
    return (
      ...
      <div class="container">
        <div>
            ...
            <p class="desc">Robotics is the intersection of science, engineering, and technology that produces machinies called Robotics.</p>
        </div>
        <div>
            <img class="img" src="https://assets.ccbp.in/frontend/intermediate-rwd/robotics-img.png"/>
        </div>
    </div>
    </div>
    )
